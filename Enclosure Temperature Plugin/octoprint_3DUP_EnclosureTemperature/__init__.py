...
class TemperaturelegendmoverPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		return dict(
			js=[
				"js/TemperatureLegendMover.js",
				"js/ResetSettingsUtilV2.js"
			],
			css=["css/TemperatureLegendMover.css"],
			less=["less/TemperatureLegendMover.less"]
		)
	...
	def get_update_information(self):
		...
		return dict(
			TemperatureLegendMover=dict(
				...
				type="github_release",
				user="OllisGit",
				repo="OctoPrint-TemperatureLegendMover",
...
__plugin_name__ = "TemperatureLegendMover"
...
def __plugin_load__():
	...
	__plugin_implementation__ = TemperaturelegendmoverPlugin()
